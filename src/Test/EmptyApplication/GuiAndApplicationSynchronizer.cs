...
public class GuiAndApplicationSynchronizer : GuiAndApplicationSynchronizerBase<ApplicationModel, VishizhukelNetEmptyWindow, DemoCollectionViewSourceEntity> {
    public GuiAndApplicationSynchronizer(ApplicationModel model, VishizhukelNetEmptyWindow window, ISimpleLogger simpleLogger)
