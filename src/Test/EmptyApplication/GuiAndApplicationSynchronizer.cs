...
public class GuiAndApplicationSynchronizer : GuiAndApplicationSynchronizerBase<ApplicationModel, VishizhukelNetEmptyWindow> {
    public GuiAndApplicationSynchronizer(ApplicationModel model, VishizhukelNetEmptyWindow window, ISimpleLogger simpleLogger) : base(model, window, simpleLogger) {
    }
}